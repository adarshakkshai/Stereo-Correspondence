...
/*
****************************************************************************************
Adarsh Akkshai Venkataramani and Ieeshan Sharma, Electrical Engineering, 508 - Dr. Karam
****************************************************************************************
*/
using namespace cv;
using namespace std;
...
int main(int argc, char const *argv[])
{
  ...
  namedWindow("IMG-LEFT", WINDOW_NORMAL);
  namedWindow("IMG-RIGHT", WINDOW_NORMAL);
  namedWindow("IMG-DISP", WINDOW_NORMAL);
  while (1) {
